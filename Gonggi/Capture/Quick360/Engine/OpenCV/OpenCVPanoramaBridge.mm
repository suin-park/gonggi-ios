...
+ (OpenCVPanoramaStitchResult *)stitchWithRequest:(OpenCVPanoramaStitchRequest *)request {
    ...
    @try {
        ...
        NSDictionary *dict = @{
            ...
            @"memoryAfterMatchMB": @(metrics.memoryAfterMatchMB),
            @"memoryAfterBAMB": @(metrics.memoryAfterBAMB),
            @"memoryAfterWarpMB": @(metrics.memoryAfterWarpMB),
            @"memoryBeforeExposureMB": @(metrics.memoryBeforeExposureMB),
            @"memoryAfterExposureMB": @(metrics.memoryAfterExposureMB),
            @"memoryBeforeSeamMB": @(metrics.memoryBeforeSeamMB),
            @"memoryAfterSeamMB": @(metrics.memoryAfterSeamMB),
            @"memoryBeforeBlendMB": @(metrics.memoryBeforeBlendMB),
            @"memoryAfterBlendMB": @(metrics.memoryAfterBlendMB),
            @"memoryAfterEncodeMB": @(metrics.memoryAfterEncodeMB),
            @"exposureAnalysisLongEdgeUsed": @(metrics.exposureAnalysisLongEdgeUsed),
            @"seamAnalysisLongEdgeUsed": @(metrics.seamAnalysisLongEdgeUsed),
            @"blendBandsUsed": @(metrics.blendBandsUsed),
