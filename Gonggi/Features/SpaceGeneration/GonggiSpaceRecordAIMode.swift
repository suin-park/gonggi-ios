...
/// Build 61–64 TestFlight validation: explicit H12 actual-pose scaffold opt-in.
///
...
enum GonggiSpaceRecordAIMode {
    ...
    /// Build 64: VR motion-first viewer (same scaffold opt-in for capture validation).
    static let scaffoldValidationBuildNumbers: Set<String> = ["61", "62", "63", "64"]
    ...
    static var scaffoldValidationBuildNumber: String { "64" }
